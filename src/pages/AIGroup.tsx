                ...
                <form onSubmit={handleCreate} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <option value="gemini-3.5-flash" className="bg-[#121212] text-white">Gemini 3.5 Flash (Standard - Recommended)</option>
                        <option value="gemini-2.5-flash" className="bg-[#121212] text-white">Gemini 2.5 Flash (Fast)</option>
                      </select>
                    </div>
                  </div>
