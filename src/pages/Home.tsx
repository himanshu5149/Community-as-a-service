...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-bg-dark">
      ...
      <section className="py-48 px-10 relative z-30">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-48 grid grid-cols-2 md:grid-cols-4 gap-12 border-t border-white/5 pt-24">
            {[
              { val: stats.communities, label: 'Active Communities' },
      ...
      {/* Trust Section / Testimonial Placeholder */}
      <section className="py-24 px-10 relative z-30 bg-primary/5 border-y border-white/5">
